...
import { FaClock, FaUser, FaEye, FaBolt } from 'react-icons/fa';
      ...
      <Link href={/news/ + article.slug} className="block group">
        ...
        >
          {article.imageUrl ? (
            ...
            <div className="flex-shrink-0 w-16 h-16 rounded-lg flex items-center justify-center text-xl" style={{ background: 'var(--bg-surface)' }}>
              ⚽
            </div>
          )}
    ...
    <Link href={/news/ + article.slug} className="block group h-full">
      ...
      >
        ...
        <div className="relative overflow-hidden" style={{ paddingBottom: '56.25%' }}>
          ...
          {article.featured && (
            <div
              className="absolute top-2 left-2 text-xs font-bold px-2 py-0.5 rounded shadow"
              style={{ background: 'rgba(255,171,0,0.95)', color: '#000' }}
            >
              Featured
            </div>
          )}
